...
for(let card of cards){
    ...
    document.addEventListener("Click", header, function(){
...
for(let menu of menus){
    ...
    document.addEventListener("click", menuBtn, function(){
